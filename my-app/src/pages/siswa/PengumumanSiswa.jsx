...
import { Bell, Calendar, Eye, AlertTriangle, Megaphone } from 'lucide-react'
...
function PengumumanSiswa() {
  ...
  // Filter pengumuman yang relevan untuk siswa
  const pengumumanRelevan = pengumuman.filter(p => 
    p.target === 'siswa' || p.target === 'semua'
  )
  ...
  return (
    <div className="space-y-6">
      ...
      {pengumumanRelevan.some(p => p.penting) && (
        <motion.div
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-red-800">Pengumuman Penting!</h3>
              <p className="text-red-700 text-sm">
                Ada {pengumumanRelevan.filter(p => p.penting).length} pengumuman penting yang perlu diperhatikan.
              </p>
            </div>
          </div>
        </motion.div>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-600">Baca</span>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-gray-200">
              <p className="text-sm text-gray-600">
                Pengumuman ini ditujukan untuk: <span className="font-medium capitalize">{selectedPengumuman.target}</span>
              </p>
            </div>
          </div>
        )}
